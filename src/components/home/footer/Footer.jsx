  ...
  return (
    <div className='footer'>
      ...
      <div className='thirddiv'>
        ...
        <div className='line'></div>
        <div className='bar'>
          <div className='bar1'><img className='barimg' src={email} alt=''></img><Link to="">kundanprasadyadav@gmail.com</Link></div>
          <div className='bar1'><img className='barimg' src={phone} alt=''></img>7667471610</div>
